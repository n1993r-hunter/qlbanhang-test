...
<body>
    ...
    <div class="table-container" style="width: 100%; max-width: 1000px; background: white; padding: 20px; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
        ...
        <h2 style="margin-top: 0;">Kết quả tìm kiếm</h2>

        <div class="header-actions">
            <a href="index.jsp" class="btn">Quay lại danh sách</a>
            
            <form action="search.jsp" method="get" class="search-box">
                <input type="text" name="keyword" value="<%= request.getParameter("keyword") != null ? request.getParameter("keyword") : "" %>" placeholder="Nhập tên hoặc phần trăm..." required>
        ...
        <table>
            ...
            <tbody>
                <%
                    // Lấy từ khóa và gọi hàm search từ DAO
                    String keyword = request.getParameter("keyword");
                    if (keyword != null && !keyword.trim().isEmpty()) {
                        dal.VatTuDAO dao = new dal.VatTuDAO();
                        java.util.List<model.VatTu> danhSach = dao.search(keyword);
                ...
                %>
                    <tr>
                        <td colspan="5" style="text-align: center; color: red;">Không tìm thấy vật tư nào phù hợp với từ khóa "<%= keyword %>"</td>
                    </tr>
                <%
                        }
                    }
